...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 25.541464
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 4.679309
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 3.389968
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 9.077971
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.471792
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 3.059715
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 50.723564
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.143665
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.332567
  type: 'suite'
  ...
1..2
# tests 7
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 25.001563
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 3.805851
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 2.820992
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 9.621443
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.122782
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 2.640361
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 48.360874
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.131225
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.305366
  type: 'suite'
  ...
1..2
# tests 7
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 23.848352
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 4.493575
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
    ...
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 9.558781
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.493242
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 3.021188
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 49.369155
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 24.021154
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 4.117869
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 3.189096
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 9.594641
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.598316
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
...
# Subtest: server startup
    ...
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.137525
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.363932
  type: 'suite'
  ...
1..2
# tests 7
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 22.741994
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 3.694135
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 2.954062
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 10.546608
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.171518
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 2.616246
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 47.125604
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.131265
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.313111
  type: 'suite'
  ...
1..2
# tests 7
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 25.038855
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 4.668589
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 3.429097
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 10.838127
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.481725
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 3.440448
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 52.335873
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
...
# Subtest: API endpoints
    ...
    ok 1 - GET /api/health returns OK
      ---
      duration_ms: 22.841285
      ...
    # Subtest: GET /api/ready returns 503 when OpenAI key is missing
    ok 2 - GET /api/ready returns 503 when OpenAI key is missing
      ---
      duration_ms: 3.880257
      ...
    # Subtest: GET /api/ready returns 200 when OpenAI key is configured
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 2.922363
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 8.872025
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.167717
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
...
# Subtest: API endpoints
    ...
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 2.987829
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 8.713763
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
      duration_ms: 3.148848
      ...
    # Subtest: echoes X-Request-Id when provided
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 2.704443
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 45.892179
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.143888
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.357705
  type: 'suite'
  ...
1..2
# tests 7
...
```
PASS
added 143 packages, and audited 144 packages in 2s
...
# Subtest: API endpoints
    ...
    ok 3 - GET /api/ready returns 200 when OpenAI key is configured
      ---
      duration_ms: 3.460659
      ...
    # Subtest: POST /api/classify rejects invalid payloads
    ok 4 - POST /api/classify rejects invalid payloads
      ---
      duration_ms: 9.315636
      ...
    # Subtest: POST /api/classify rejects missing stem for multiple choice
    ok 5 - POST /api/classify rejects missing stem for multiple choice
      ---
    ...
    ok 6 - echoes X-Request-Id when provided
      ---
      duration_ms: 3.105148
      ...
    1..6
ok 1 - API endpoints
  ---
  duration_ms: 53.769966
  type: 'suite'
  ...
# Subtest: server startup
    # Subtest: listen only when executed directly
    ok 1 - listen only when executed directly
      ---
      duration_ms: 0.146623
      ...
    1..1
ok 2 - server startup
  ---
  duration_ms: 0.370619
  type: 'suite'
  ...
1..2
# tests 7
